...
This emulator implements the complete firmware API (66 opcodes) over a virtual COM port, enabling:
...
- **Firmware API**: All 66 opcode handlers (device readiness, sensors, light-camera, lamps, motors, encoders, interrupt triggers)
...
See **OPCODES_REFERENCE.md** for complete documentation of all 66 implemented opcodes.
